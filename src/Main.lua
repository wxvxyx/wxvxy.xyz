--[[
	...
	wxvxy.xyz by wxvxy © CC0 1.0 Universal (2023)
	https://github.com/wxvxy
...
InformationSection:Label("Made by wxvxy")

InformationSection:Button({
	Name = "Copy GitHub",
	Callback = function()
		setclipboard("https://github.com/wxvxy")
	end
})

InformationSection:Label("DrippyTeam © 2022 - "..osdate("%Y"))
